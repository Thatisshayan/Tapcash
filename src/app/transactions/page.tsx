...
import { 
  Coins, Wallet, Landmark, ChevronRight, X, ArrowUpRight, ArrowDownLeft, 
...
export default function RedemptionsVaultPage() {
      ...
      <div className="min-h-screen bg-[#060606] text-white flex flex-col">
        ...
        <main className="flex-grow flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-zinc-950/40 border border-zinc-900 rounded-3xl p-8 text-center backdrop-blur-xl">
            ...
            <p className="text-zinc-500 text-sm mb-6">Please log in to your account to view your cashout vault and transactions.</p>
    ...
    <div className="min-h-screen bg-[#060606] text-white flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-zinc-900">
          <div>
            <h1 className="text-3xl font-black text-white tracking-tight">Redemptions Vault</h1>
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-black text-white tracking-tight">Ledger Records</h2>
            <p className="text-zinc-500 text-xs mt-0.5">Live tracking of your earnings and redemptions.</p>
          </div>
