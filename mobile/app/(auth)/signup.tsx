...
export default function SignUpScreen() {
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      <ScreenFrame eyebrow="Create account" title="Join the verified flow." description="Sign up on mobile, confirm your inbox, then open the full TapCash shell.">
        <View style={styles.card}>
          ...
          <TextInput value={name} onChangeText={setName} placeholder="John Doe" placeholderTextColor={theme.colors.dim} style={styles.input} />
